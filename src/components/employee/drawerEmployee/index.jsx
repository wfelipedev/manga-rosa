        ...
        <List>
          <ListItem
            ...
            className={clsx(
              ...
              routeSelected === "inicio" ? classes.drawerSelected : ""
            )}
            to="/inicio"
          >
            <ListItemIcon>
          ...
          <ListItem
            ...
            className={clsx(
              classes.drawerButtons,
              routeSelected === "checkout" ? classes.drawerSelected : ""
            )}
            to="/inicio"
          >
            <ListItemIcon>
              <Clipboard style={{ color: "#c11f94" }} />
            </ListItemIcon>
            <ListItemText>
              <Typography style={{ fontWeight: "bold" }}>Pontos</Typography>
            </ListItemText>
          </ListItem>
        </List>
      </Drawer>
